...
import { Home, Trophy, BarChart3, Calendar, Users, ShoppingCart, Newspaper } from 'lucide-react'

export type DtTab = 'home' | 'competitions' | 'stats' | 'calendar' | 'squad' | 'market' | 'news'
